...
@router.get("/{athlete_id}/medical_records", response_model=list[schemas.MedicalRecordOut])
...
@router.post("/{athlete_id}/medical_records", response_model=schemas.MedicalRecordOut)
...
@router.get("/{athlete_id}/training_sessions", response_model=list[schemas.TrainingSessionOut])
...
@router.post("/{athlete_id}/training_sessions", response_model=schemas.TrainingSessionOut)
